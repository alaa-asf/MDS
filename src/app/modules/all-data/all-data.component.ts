...
import {codeToString} from "../../shared/constant/states";
...
export class AllDataComponent extends BaseComponent implements OnInit {
    ...
    getData() {
        this.filters.phoneNumber = this.filters.phoneNumber?this.filters.phoneNumber:null
        ...
        this.loading = true
        this.reportsService.getAll(this.filters).subscribe((el: any) => {
          this.data = el.data
