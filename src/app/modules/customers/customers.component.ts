...
export class CustomersComponent extends BaseComponent implements OnInit {
    ...
    resetFilter(){
        this.filters.customerPhone = null
    ...
    getData() {
        this.filters.customerPhone = this.filters.customerPhone ? this.filters.customerPhone : null
        ...
        this.loading = true
        this.reportsService.getCustomersData(this.filters).subscribe((el: any) => {
            this.data = el.data
